...
* tau2 = nout vector of MCMC iterates
...
void mcmcloopM2a1(int *draws, int *burn, int *thin, int *nobsi1, int *nobsi2,
			        int *nschool, int *ncov, int *school1, int *school2,
...
//	RprintVecAsMat("ybari_1", ybari_1, 1, *nschool);
//	RprintVecAsMat("xbari_1", xbari_1, *nschool, *ncov);
//	RprintVecAsMat("sY1X1", sY1X1, 1, *ncov);
//	RprintVecAsMat("tX1X1", tX1X1, *ncov, *ncov);
//	Rprintf("sybar2 = %f\n", sybar2);
//	Rprintf("y2_1 = %f\n", y2_1);
	...
	double xb, mstar, s2star, phi1sq, va, ma, a1_mn;
...
//RprintVecAsMat("iB0", iB0, *ncov, *ncov);
	...
	tmp = rnorm(mub[0], sqrt(s2b));
	double *beta1_iter = R_VectorInit((*ncov), tmp);
	double *beta2_iter = R_VectorInit((*ncov), tmp);

	tmp = rnorm(mp, sqrt(s2p));
	double *alpha1_iter = R_VectorInit(*nschool, tmp);
	double *alpha2_iter = R_VectorInit(*nschool, tmp);

	double sig21_iter = 1.0/rgamma(as, 1.0/bs);;
	double sig22_iter = 1.0/rgamma(as, 1.0/bs);;

	double tau21_iter = 1.0/rgamma(at, 1.0/bt);
	double tau22_iter = 1.0/rgamma(at, 1.0/bt);
...
/*
    //////////////////////////////////////////////////////////////////////////////////
    //
		// update sig21. The variability associated with y1 give covariates random effect.
		//
		//////////////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////////////////////////
    //
		// update sig22. The variability associated with y2 give covariates random effect.
		//
		//////////////////////////////////////////////////////////////////////////////////
		ssq = 0.0;
		for(t = 0; t < N2; t++){
